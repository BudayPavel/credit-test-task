...
app-init: app-composer-install app-migrations app-migrations-test app-fixtures
...
app-fixtures:
	docker-compose run --rm credit-test-php-cli php bin/console do:fixtures:load -n
